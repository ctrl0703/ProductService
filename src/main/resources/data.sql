INSERT INTO PRODUCT (CODE, NAME, PRICE, CATEGORY, CREATE_DATE, CREATE_ID)
VALUES ('11111', '브라이트닝 포어 세럼 30mL', 35000, 'B', SYSDATE, 'SYSTEM');

INSERT INTO PRODUCT (CODE, NAME, PRICE, CATEGORY, CREATE_DATE, CREATE_ID)
VALUES ('22222', '포레스트 포맨 올인원 에센스 4종 100mL', 25000, 'B', SYSDATE, 'SYSTEM');

INSERT INTO PRODUCT (CODE, NAME, PRICE, CATEGORY, CREATE_DATE, CREATE_ID)
VALUES ('33333', '트루케어 AC 진정 앰플 40mL', 28000, 'B', SYSDATE, 'SYSTEM');

INSERT INTO PRODUCT (CODE, NAME, PRICE, CATEGORY, CREATE_DATE, CREATE_ID)
VALUES ('44444', '트루케어 알란토인 워터드롭 에센스 150mL', 28000, 'B', SYSDATE, 'SYSTEM');

INSERT INTO PRODUCT (CODE, NAME, PRICE, CATEGORY, CREATE_DATE, CREATE_ID)
VALUES ('55555', '트루케어 시카 AA 트리트먼트 크림 50mL', 25000, 'C', SYSDATE, 'SYSTEM');

INSERT INTO PRODUCT (CODE, NAME, PRICE, CATEGORY, CREATE_DATE, CREATE_ID)
VALUES ('66666', '그린티 밸런싱 스킨 EX', 25000, 'A', SYSDATE, 'SYSTEM');

INSERT INTO PRODUCT (CODE, NAME, PRICE, CATEGORY, CREATE_DATE, CREATE_ID)
VALUES ('77777', '더 미니멈 토너 45mL', 25000, 'A', SYSDATE, 'SYSTEM');

INSERT INTO PRODUCT (CODE, NAME, PRICE, CATEGORY, CREATE_DATE, CREATE_ID)
VALUES ('88888', '진저허니 앰플 스킨 200mL', 25000, 'A', SYSDATE, 'SYSTEM');

INSERT INTO PRODUCT (CODE, NAME, PRICE, CATEGORY, CREATE_DATE, CREATE_ID)
VALUES ('99999', '청보리 필링 토너 250mL', 25000, 'A', SYSDATE, 'SYSTEM');
...
INSERT INTO CATEGORY (CATEGORY_CODE, NAME, DEPTH, CAT_ORDER, CREATE_DATE, CREATE_ID) VALUES ('F', '온라인 전용관', 1, 6, SYSDATE, 'SYSTEM');
INSERT INTO CATEGORY (CATEGORY_CODE, NAME, DEPTH, CAT_ORDER, CREATE_DATE, CREATE_ID) VALUES ('G', 'MY SHOP 전용관', 1, 7, SYSDATE, 'SYSTEM');
INSERT INTO CATEGORY (CATEGORY_CODE, NAME, DEPTH, CAT_ORDER, CREATE_DATE, CREATE_ID) VALUES ('H', 'PLAY GREEN 전용관', 1, 8, SYSDATE, 'SYSTEM');
INSERT INTO CATEGORY (CATEGORY_CODE, NAME, SUPER_CATEGORY_CODE, DEPTH, CAT_ORDER, CREATE_DATE, CREATE_ID) VALUES ('UA', '스킨케어', 'A', 2, 2, SYSDATE, 'SYSTEM');
